...
import { Product, ProductCategory } from 'product-domain';
import { AnyPipe, MaterialModule, MoneyPipe } from 'shared-ui';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: 'ENV',
          useValue: { STATIC_ASSETS_BASE_URL: 'http://localhost:3000' },
        },
        provideMockStore(),
      ],
    }).compileComponents();
