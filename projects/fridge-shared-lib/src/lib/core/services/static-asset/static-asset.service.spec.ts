...
import { FileWithUrl } from '@shared/file-upload/classes/file-with-url/file-with-url.class';
import { UrlInterceptor } from '@shared/core/interceptors/url/url.interceptor';
